...
const LandingPage = ({ onNavigate }) => (
  <div className="text-center flex flex-col items-center p-4 animate-fade-in">
    <img src={LOGO} alt="Noir Capital Logo" className="h-24 w-auto mb-6" />
    <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">NOIR CAPITAL</h1>
    <p className="text-lg text-gray-400 mb-10 max-w-2xl">Welcome to the Noir Capital secure portal. Please select your access point.</p>
